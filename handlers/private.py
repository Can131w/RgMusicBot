...
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton("Katkıda Bulunan 😎", url="https://t.me/EfsaneStar"),
...
async def gstart(_, message: Message):
      await message.reply_text(
          ...
          reply_markup=InlineKeyboardMarkup(
              [[
              InlineKeyboardButton(text="🗣️ Sohbet Group 👩‍👩‍👧‍👦", url="https://t.me/RgSohbet")
              ]]
          )
      )


@Client.on_message(filters.command(["Komutlar", "start@RgSohbet"]) & filters.private & ~filters.channel)
